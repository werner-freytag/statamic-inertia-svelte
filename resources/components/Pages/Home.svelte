...
<div class="relative flex min-h-dvh flex-col overflow-hidden bg-zinc-50 font-[InterVariable,Inter,sans-serif] text-zinc-800 antialiased [font-feature-settings:'cv02','cv03','cv04','cv11','ss01'] dark:bg-zinc-950 dark:text-zinc-300">
    <div class="pointer-events-none absolute inset-0" aria-hidden="true">
        <div class="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(212,255,76,0.18),transparent)] dark:bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(255,38,158,0.16),transparent)]"></div>
        <div class="absolute inset-0 bg-[linear-gradient(to_right,rgba(24,24,27,0.04)_1px,transparent_1px),linear-gradient(to_bottom,rgba(24,24,27,0.04)_1px,transparent_1px)] bg-size-[48px_48px] mask-[radial-gradient(ellipse_70%_60%_at_50%_30%,black,transparent)] dark:bg-[linear-gradient(to_right,rgba(255,255,255,0.04)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.04)_1px,transparent_1px)]"></div>
        <div class="absolute top-1/4 left-1/2 size-96 -translate-x-1/2 rounded-full bg-[#d4ff4c]/20 blur-3xl dark:bg-[#FF269E]/25"></div>
    </div>

    <main class="relative mx-auto flex w-full max-w-3xl grow flex-col justify-center px-6 py-16 sm:px-8 sm:py-20">
        <a
            href="https://statamic.com"
            class="inline-flex w-fit origin-left animate-[fade-up_0.7s_ease-out_both] transition-transform hover:-translate-y-0.5"
        >
            <span class="sr-only">Statamic</span>
            <svg class="h-8 w-auto text-zinc-950 dark:hidden sm:h-9" viewBox="0 0 614.9 112.01" fill="none" aria-hidden="true">
                <path
                    class="fill-current"
        ...
        <div class="mt-8 flex flex-wrap items-center gap-3 animate-[fade-up_0.7s_ease-out_both] [animation-delay:220ms]">
            <a
                href="/cp"
                class="inline-flex items-center gap-x-2 rounded-lg bg-zinc-950 py-2.5 pr-3 pl-2.5 text-sm font-medium text-white ring-1 ring-zinc-950 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-950 dark:bg-white dark:text-zinc-950 dark:ring-white dark:focus-visible:outline-white"
            >
                <svg class="size-4 shrink-0 fill-white dark:fill-zinc-950" viewBox="0 0 16 16" aria-hidden="true">
            ...
            <a
                ...
                class="inline-flex items-center gap-x-1.5 rounded-lg px-3 py-2.5 text-sm font-medium text-zinc-700 ring-1 ring-zinc-950/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-950 dark:text-zinc-200 dark:ring-white/10 dark:focus-visible:outline-white"
            >
                Read the docs
                <svg class="size-4 shrink-0 fill-zinc-400 dark:fill-zinc-500" viewBox="0 0 16 16" aria-hidden="true">
        ...
        <div class="mt-14 animate-[fade-up_0.7s_ease-out_both] [animation-delay:320ms] sm:mt-16">
            <h2 class="text-sm font-medium tracking-tight text-zinc-500">Where to go from here</h2>

            <ul class="mt-4 grid grid-cols-1 gap-px overflow-hidden rounded-2xl bg-zinc-950/5 ring-1 ring-zinc-950/5 sm:grid-cols-2 dark:bg-white/5 dark:ring-white/10">
                <li class="group relative col-span-full flex items-start gap-x-4 bg-white p-5 sm:p-6 dark:bg-zinc-950 dark:inset-ring dark:inset-ring-white/5">
                    <svg class="mt-0.5 size-5 shrink-0 fill-zinc-950 dark:fill-white" viewBox="0 0 20 20" aria-hidden="true">
                    ...
                    <div class="min-w-0 grow">
                        <h3 class="text-base font-medium tracking-tight text-zinc-950 sm:text-sm dark:text-white">
                            <a href="/cp" class="before:absolute before:inset-0">Control Panel</a>
                        </h3>
                        <p class="mt-1 text-base text-pretty text-zinc-600 sm:text-sm dark:text-zinc-400">Edit this page, shape blueprints, and start building collections.</p>
                    </div>
                    <svg class="mt-1 size-4 shrink-0 fill-zinc-300 transition-transform group-hover:translate-x-0.5 dark:fill-zinc-600" viewBox="0 0 16 16" aria-hidden="true">
                        <path fill-rule="evenodd" d="M2 8c0 .414.336.75.75.75h8.69l-1.22 1.22a.75.75 0 1 0 1.06 1.06l2.5-2.5a.75.75 0 0 0 0-1.06l-2.5-2.5a.75.75 0 1 0-1.06 1.06l1.22 1.22H2.75A.75.75 0 0 0 2 8Z" clip-rule="evenodd" />
                    </svg>
                </li>

                <li class="relative flex items-start gap-x-4 bg-white p-5 sm:p-6 dark:bg-zinc-950 dark:inset-ring dark:inset-ring-white/5">
                    <svg class="mt-0.5 size-5 shrink-0 fill-zinc-950 dark:fill-white" viewBox="0 0 20 20" aria-hidden="true">
                        <path d="M10.75 16.82A7.485 7.485 0 0 0 15 15.5c.71 0 1.396.098 2.046.282A.75.75 0 0 0 18 15.06v-11a.75.75 0 0 0-.546-.721A9.005 9.005 0 0 0 15 3a7.478 7.478 0 0 0-4.25 1.32V16.82ZM9.25 4.32A7.478 7.478 0 0 0 5 3c-.85 0-1.673.118-2.454.339A.75.75 0 0 0 2 4.06v11a.75.75 0 0 0 .954.721A9.005 9.005 0 0 1 5 15.5c1.612 0 3.113.451 4.25 1.32V4.32Z" />
                    </svg>
                    <div class="min-w-0 grow">
                        <h3 class="text-base font-medium tracking-tight text-zinc-950 sm:text-sm dark:text-white">
                            <a href="https://statamic.dev" class="before:absolute before:inset-0">Documentation</a>
                        </h3>
                        <p class="mt-1 text-base text-pretty text-zinc-600 sm:text-sm dark:text-zinc-400">Learn how Statamic works end to end.</p>
                    </div>
                </li>
                ...
                <li class="relative flex items-start gap-x-4 bg-white p-5 sm:p-6 dark:bg-zinc-950 dark:inset-ring dark:inset-ring-white/5">
                    ...
                    <div class="min-w-0 grow">
                        <h3 class="text-base font-medium tracking-tight text-zinc-950 sm:text-sm dark:text-white">
                            <a href="https://youtube.com/statamic" class="before:absolute before:inset-0">Videos</a>
                        </h3>
                        <p class="mt-1 text-base text-pretty text-zinc-600 sm:text-sm dark:text-zinc-400">Watch walkthroughs on YouTube.</p>
                    </div>
                </li>
                ...
                <li class="relative flex items-start gap-x-4 bg-white p-5 sm:p-6 dark:bg-zinc-950 dark:inset-ring dark:inset-ring-white/5">
                    ...
                    <div class="min-w-0 grow">
                        <h3 class="text-base font-medium tracking-tight text-zinc-950 sm:text-sm dark:text-white">
                            <a href="https://statamic.com/discord" class="before:absolute before:inset-0">Discord</a>
                        </h3>
                        <p class="mt-1 text-base text-pretty text-zinc-600 sm:text-sm dark:text-zinc-400">Hang with thousands of Statamic folks.</p>
                    </div>
                </li>

                <li class="relative flex items-start gap-x-4 bg-white p-5 sm:p-6 dark:bg-zinc-950 dark:inset-ring dark:inset-ring-white/5">
                    <svg class="mt-0.5 size-5 shrink-0 fill-zinc-950 dark:fill-white" viewBox="0 0 20 20" aria-hidden="true">
                        <path fill-rule="evenodd" d="M10 3c-4.31 0-8 3.033-8 7 0 2.024.978 3.825 2.499 5.085a3.471 3.471 0 0 1-.866 1.942 5.111 5.111 0 0 0 3.826-1.415A8.21 8.21 0 0 0 10 17c4.31 0 8-3.033 8-7s-3.69-7-8-7ZM6.75 9.25a.75.75 0 0 0 0 1.5h6.5a.75.75 0 0 0 0-1.5h-6.5Zm0 2.5a.75.75 0 0 0 0 1.5h3.5a.75.75 0 0 0 0-1.5h-3.5Z" clip-rule="evenodd" />
                    </svg>
                    <div class="min-w-0 grow">
                        <h3 class="text-base font-medium tracking-tight text-zinc-950 sm:text-sm dark:text-white">
                            <a href="https://github.com/statamic/cms/discussions" class="before:absolute before:inset-0">Discussions</a>
                        </h3>
                        <p class="mt-1 text-base text-pretty text-zinc-600 sm:text-sm dark:text-zinc-400">Ask questions and get unstuck.</p>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <footer class="relative mx-auto w-full max-w-3xl px-6 pb-10 sm:px-8">
        <p class="text-sm text-zinc-500">
            <a href="https://github.com/statamic/cms" class="font-medium text-zinc-700 underline decoration-zinc-950/15 underline-offset-3 hover:decoration-zinc-950 dark:text-zinc-300 dark:decoration-white/20 dark:hover:decoration-white">Star Statamic on GitHub</a>
